...
console.warn("Hi ".concat(list[1], " I have arranged a dinner party at my place I would like to invite you,I hope you will come thanks."));
console.warn("Hi ".concat(list[2], " I have arranged a dinner party at my place I would like to invite you,I hope you will come thanks."));
console.warn("Hi ".concat(list[3], " I have arranged a dinner party at my place I would like to invite you,I hope you will come thanks."));
console.warn("Hi ".concat(list[4], " I have arranged a dinner party at my place I would like to invite you,I hope you will come thanks."));
...
console.log("Iam sorry ".concat(list[4], " i can not invite you on dinner"));
list.pop();
console.log("Iam sorry ".concat(list[3], " i can not invite you on dinner"));
list.pop();
console.log("Iam sorry ".concat(list[2], " i can not invite you on dinner"));
list.pop();
console.log("Hi ".concat(list[0], " You are still invited at dinner"));
console.log("Hi ".concat(list[1], " You are still invited at dinner"));
list.pop();
list.pop();
console.log(list);
